...
function sumarTresNumeros(num1: number, num2: number, num3: number): number {
...
function obtenerNombreCompleto2(nombre: string, apellido1: string, apellido2: string): string {
