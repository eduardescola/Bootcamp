...
let nombre = "Eduard"; // Inicializando con un valor
...
let edad = 25; // Inicializando con un valor
...
let esEstudiante = true; // Inicializando con un valor
...
let numeros = [1, 2, 3, 4, 5]; // Inicializando con un arreglo de números
...
let persona = { nombre: "Juan", edad: 30 }; // Inicializando con un objeto
...
let valorNulo = null; // Inicializando con un valor null
...
let valorIndefinido = undefined; // Inicializando con un valor undefined
...
function miFuncion() {
    let localVar = "Esta es una variable local"; // Local dentro de la función
